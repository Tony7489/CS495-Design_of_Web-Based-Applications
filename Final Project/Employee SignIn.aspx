<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee SignIn.aspx.cs" Inherits="Final_Project.Employee_SignIn" %>
...
<script runat="server">
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        string strSelect = "SELECT * FROM Employee "
            + " WHERE ID = '" + txtId.Text + "' AND Password = '" + txtPassword.Text + "'";
            ...
            <tr>
                <td class="auto-style1">
                    <asp:Label ID="Label2" runat="server" Font-Names="Arial" Font-Size="Medium" 
                        ForeColor="#000066" Text="ID:"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtId" runat="server" Font-Names="Arial" 
