...
<script runat="server">
    protected void btnRegister_Click(object sender, EventArgs e)
    {
        ...
        conn.Close();
        if (photo.HasFile)
            photo.SaveAs(Server.MapPath("PersonalPhoto") + "\\" + txtNaID.Text + ".jpg");
        lblMsg.Text = "Welcome " + txtFNameE.Text + " " + txtMNameE.Text + " "  + txtLNameE.Text + " Your Account has been successfully created!!";
        clear();
    }
    protected void btnClear_Click(object sender, EventArgs e)
    {
        clear();
        lblMsg.Text = "The Function has been executed Successfully!!";
    }
    void clear()
    {
        txtStudentId.Text = "";
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style7" colspan="4">
                    <center>
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="#000099" Text="Sign Up Form"></asp:Label>
                </center>
            ...
            <tr>
                ...
                &nbsp;&nbsp;&nbsp;
                    ...
                    <br />
                    <span class="auto-style6">e.g. user@domain.comain.com</span></td>
            </tr>
            <tr>
                <td class="auto-style29">
                    &nbsp;</td>
            ...
            <tr>
                ...
                &nbsp;&nbsp;&nbsp;
                    ...
                    <br />
                    <span class="auto-style6">e.g. 20185678</span></td>
            </tr>
            <tr>
                <td class="auto-style2">
                    &nbsp;</td>
            ...
            <tr>
                ...
                <td class="auto-style25" colspan="3">
                    <asp:TextBox ID="txtNaID" runat="server" Width="65%"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="txtNaID" ErrorMessage="*" Font-Italic="True" Font-Size="Medium" ForeColor="Red"></asp:RequiredFieldValidator>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator13" runat="server" ControlToValidate="txtNaID" ErrorMessage="wrong" Font-Italic="True" Font-Size="Medium" ForeColor="Red" ValidationExpression="\d{14}"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
            ...
            <tr>
                ...
                <td class="auto-style22" colspan="3">
                    <asp:DropDownList ID="DDLC" runat="server" Width="70%">
                        <asp:ListItem Value="H.S">HighSchool</asp:ListItem>
            ...
            <tr>
                <td class="auto-style32">
                    <asp:Button ID="btnRegister" runat="server" Text="Register" OnClick="btnRegister_Click" BackColor="#FFFFCC" BorderColor="#000099" BorderStyle="Solid" BorderWidth="2px" Font-Bold="True" Font-Italic="False" Font-Names="Arial" Font-Size="Medium" ForeColor="#000099" Height="90%" Width="90%" />
                </td>
                <td class="auto-style19" colspan="3">
                    <asp:Button ID="btnClear" runat="server" Text="Clear" OnClick="btnClear_Click" BackColor="#FFFFCC" BorderColor="#000099" BorderStyle="Solid" BorderWidth="2px" Font-Bold="True" Font-Italic="False" Font-Names="Arial" Font-Size="Medium" ForeColor="#000099" Height="90%" Width="90%" />
                </td>
            </tr>
            <tr>
